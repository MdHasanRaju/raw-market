      ...
      <Box>
        <Box>
          ...
          <Typography sx={{ textAlign: "center", my: 1 }} variant="subtitle1">
            ...
            <Box sx={{ color: "#45553E" }} component="span">
              95%
            </Box>{" "}
            of companies plan to consolidate <Box component="br" /> their tech
            tools in the next year. One way to respond to this downscaling is to
            seek out technology partnerships..
          </Typography>
        </Box>
